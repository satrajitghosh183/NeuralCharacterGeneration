...
def main():
    ...
    # Trace on the DEPLOY device family when possible: tracing on MPS bakes diffusers'
    # MPS-safe (no-float64) branches into the graph, which a CPU/CUDA trace does not.
